...
import com.gentlehealthcare.mobilecare.activity.evaluation.EvaluationNursingMeasuresSecondDetailsAct;
...
public class EvaluationNursingMeasuresSecondAdapter extends BaseAdapter {
    private ArrayList<NursingMeasureBean> mList;
    private Context mContext;
    private String charSequence;

    public EvaluationNursingMeasuresSecondAdapter(ArrayList<NursingMeasureBean> list, Context context) {
        mList = list;
        mContext = context;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        view.tv_nursing_measure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(mContext, EvaluationNursingMeasuresSecondDetailsAct.class);
