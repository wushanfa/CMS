...
import com.gentlehealthcare.mobilecare.activity.evaluation.EvaluationNursingMeasuresAct;
...
public class EvaluationGradedCareEvaluationAdapter extends BaseAdapter {
    private ArrayList<GradedCareEvaluationBean> mList;
    private Context mContext;
    private String charSequence;

    public EvaluationGradedCareEvaluationAdapter(ArrayList<GradedCareEvaluationBean> list, Context context) {
        mList = list;
        mContext = context;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            view = new ViewHodler();
            convertView = View.inflate(mContext, R.layout.item_evaluation_graded_care_evaluation, null);
            ...
            view.rl_measures.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent.setClass(mContext, EvaluationNursingMeasuresAct.class);
        ...
        String[] type_check = type.split("分");
        if (Integer.parseInt(type_check[0]) >= 14) {
