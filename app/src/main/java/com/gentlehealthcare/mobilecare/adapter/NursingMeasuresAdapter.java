...
public class NursingMeasuresAdapter extends BaseAdapter {
    private ArrayList<NursingMeasureBean> mList;
    private Context mContext;
    private String charSequence;

    public NursingMeasuresAdapter(ArrayList<NursingMeasureBean> list, Context context) {
        mList = list;
        mContext = context;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            view.rl_measure_details = (RelativeLayout) convertView.findViewById(R.id.rl_measure_details);
        ...
        view.rl_measure_details.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(mContext, NursingMeasuresDetailsAct.class);
    ...
    class ViewHodler {
        ...
        RelativeLayout rl_measure_details;
    }
}
