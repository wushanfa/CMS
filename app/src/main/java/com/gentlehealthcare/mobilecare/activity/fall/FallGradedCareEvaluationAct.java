...
* 跌倒评估评估列表
* */
public class FallGradedCareEvaluationAct extends BaseActivity implements ITemperatureView, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_fall_graded_care_evaluation);
        initView();
        setadapter();
    }
    ...
    private void initView() {
        ...
        lv_evaluation_list_nursing.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent.setClass(FallGradedCareEvaluationAct.this, FallGradCareMeasureAct.class);
    ...
    private void setadapter() {
        ...
        list.add(new GradedCareEvaluationBean("2017-05-18   16:00", "15分 轻度危险", "张红婷", "嘱患者如上厕所或淋浴时有需要帮助时使用紧急呼叫器"));
        list.add(new GradedCareEvaluationBean("2017-05-17   16:00", "7分 极度危险", "李婷", "教会患者家属使用床栏方法，需下床时先将床档放下，切勿翻越"));
    ...
    public void showPatients(final List<SyncPatientBean> deptPatient) {
        dialog = new MyPatientDialog(FallGradedCareEvaluationAct.this,
                new MyPatientDialog.MySnListener() {
                    ...
                    public void onRefresh() {
                        ...
                        TemperaturePresenter.getPatients(FallGradedCareEvaluationAct.this,
                                1024);// 1000标记用来刷新
                        dialog.dismiss();
                    }
