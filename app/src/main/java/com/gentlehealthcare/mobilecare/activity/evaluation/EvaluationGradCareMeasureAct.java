...
* 压疮评估内容评估
* */
public class EvaluationGradCareMeasureAct extends BaseActivity implements ITemperatureView, IIntravenousExecuteView, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.evaluationgrad_care_measure);
        list = new ArrayList();
...
//        tv_pop_stairs.setOnClickListener(this);
        ...
        intravenousPresenter = new IntravenousPresenter(null, EvaluationGradCareMeasureAct.this, null, null);
...
//                break;
            ...
            case R.id.btn_save_assessment:
                ...
                Intent.setClass(EvaluationGradCareMeasureAct.this, EvaluationNursingMeasuresAct.class);
    ...
    private void showPopupWindow(final TextView text, final TextView score) {
        contentView = LayoutInflater.from(EvaluationGradCareMeasureAct.this).inflate(
        ...
        Pop_Grad_Care_MeasureAdapter adapter = new Pop_Grad_Care_MeasureAdapter(list, EvaluationGradCareMeasureAct.this);
        ...
        lv_grad_care_measure.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (i >= 14) {
                    tv_score.setText(" 轻度危险" + ":" + i + "分");
                    tv_score.setTextColor(getResources().getColor(R.color.black));

                } else if (i >= 12) {
                    tv_score.setText(" 中度危险" + ":" + i + "分");
                    tv_score.setTextColor(getResources().getColor(R.color.red));
                } else if (i < 12) {
                    tv_score.setText(" 高度危险" + ":" + i + "分:");
                    tv_score.setTextColor(getResources().getColor(R.color.red));
                }
            }
        });
    ...
    public void showPatients() {
        dialog = new MyPatientDialog(EvaluationGradCareMeasureAct.this,
                new MyPatientDialog.MySnListener() {
                    ...
                    public void onRefresh() {
                        ...
                        TemperaturePresenter.getPatients(EvaluationGradCareMeasureAct.this,
                                1024);// 1000标记用来刷新
                        dialog.dismiss();
                    }
