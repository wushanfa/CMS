...
public class EvaluationNursingMeasuresDetailsAct extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_change_finish:
                EventBus.getDefault().post(new ShowEvaluationTextEvent(position,tv_measure_details.getText().toString()));
                finish();
                break;
        }
    }
