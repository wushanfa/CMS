 ...
 */
public class SetStatusForAreaRequest extends ABRequest<SetStatusForAreaBean>{
     ...
     */
    public SetStatusForAreaRequest(Context context, IRespose<SetStatusForAreaBean> respose, int id, Boolean isInMainThread,SetStatusForAreaBean statusForAreaBean) {
    ...
    protected SetStatusForAreaBean connection() throws Exception {
        return (SetStatusForAreaBean) httpConnection.connection(UrlConstant.SetStatusForArea(),statusForAreaBean,getContext());
    }
