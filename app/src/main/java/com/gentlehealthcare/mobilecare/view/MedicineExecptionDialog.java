...
import com.gentlehealthcare.mobilecare.activity.patient.medicine.PatrolRecordFra;
 ...
 */
public class MedicineExecptionDialog extends Dialog implements View.OnClickListener{
    private PatrolRecordFra context;
    ...
    public MedicineExecptionDialog(PatrolRecordFra context) {
    ...
    public MedicineExecptionDialog(PatrolRecordFra context, int theme) {
