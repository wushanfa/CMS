 ...
 * 增加Pio listview的适配器
 */
public class AddPioApprisalAdapter extends BaseAdapter {

	private Context context;
	private List<PioItemInfo> list;

	public AddPioApprisalAdapter(Context context, List<PioItemInfo> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(context).inflate(
					R.layout.act_add_pio_appraisal_content, null);
