 ...
 * @author dzw
 */
public class PIOAdapter extends BaseAdapter {
    ...
    public PIOAdapter(Context context, List<SyncPatientBean> patients) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(
                    R.layout.item_orders, null);

            viewHolder.tvBedNumber = (TextView) convertView
                    .findViewById(R.id.tv_bed_number);
            viewHolder.ivPatientPhoto = (ImageView) convertView
                    .findViewById(R.id.iv_patient_photo);
            viewHolder.tvAge = (TextView) convertView.findViewById(R.id.tv_age);
            viewHolder.tvName = (TextView) convertView
                    .findViewById(R.id.tv_patientname);
            viewHolder.tvPatientId = (TextView) convertView
                    .findViewById(R.id.tv_patientid);
        ...
        if (patient.getPatId() != null)
            viewHolder.tvPatientId.setText(String.format("病人ID:%s",
                    patient.getPatCode()));
        if (patient.getAdmissionDate() != null
                && patient.getAdmissionDate().length() > 15) {
