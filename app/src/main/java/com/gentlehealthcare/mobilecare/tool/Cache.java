...
public class Cache {
    ...
    public  static Cache get(Context ctx,long max_size,int max_count){
        File file=new File(ctx.getCacheDir(),"Cache");
        return get(file,max_size,max_count);
    }

    public  static Cache get(File cacheDir,long max_size,int max_count){
